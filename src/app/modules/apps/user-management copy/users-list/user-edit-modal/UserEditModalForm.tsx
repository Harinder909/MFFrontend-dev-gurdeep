...
const UserEditModalForm: FC<Props> = ({user, isUserLoading}) => {
  ...
  const [userForEdit] = useState<User>({
    ...
    subType: user.subType || initialUser.subType,
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  checked={formik.values.investor === 'Administrator'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  checked={formik.values.investor === 'Developer'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
                {/* end::Input */}
                {/* begin::Label */}
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  checked={formik.values.investor === 'Analyst'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  checked={formik.values.investor === 'Support'}
                  disabled={formik.isSubmitting || isUserLoading}
                />
                {/* end::Input */}
                {/* begin::Label */}
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <input
                  ...
                  value='Trial'
                  checked={formik.values.investor === ''}
                  disabled={formik.isSubmitting || isUserLoading}
                />
                {/* end::Input */}
                {/* begin::Label */}
